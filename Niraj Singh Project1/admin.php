        ...
        <div class="navbar">
            ...
            <nav>
                <ul id="MenuItems">
                    ...
                    <li><a href="logout.php"><i class="fa fa-sign-out" style="font-size:25px;color:black"></i></a></li>          
                </ul>
            </nav>
...
if(isset($message)){
   foreach($message as $message){
      echo '<div class="message"><span>'.$message.'</span> <i class="fas fa-times" onclick="this.parentElement.style1.display = `none`;"></i> </div>';
   };
};
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <button type="reset" value="cancel" id="close-edit" class="option-btn">Cancel</button>
   </form>
