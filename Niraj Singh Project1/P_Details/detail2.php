...
<!--------------------------------------------SINGLE PRODUCT DETAILS--------------------------------------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Products/P2.1.jpg" width="100%" id="ProductImg">
                <div class="small-img-row" >
                    <div class="small-img-col">
                        <img src="Products/P2.1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P2.2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P2.3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P2.4.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home / Watch</p>
                <h1>DIZO Watch D 1.8 inch Dynamic display with 550nits brightness (by realme techLife)</h1>
                <h5>&#8377; 2499.00</h5>
