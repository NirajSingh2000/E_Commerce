...
<!--------------------------------------------SINGLE PRODUCT DETAILS--------------------------------------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Products/9.1.jpg" width="100%" id="ProductImg">
                <div class="small-img-row" >
                    <div class="small-img-col">
                        <img src="Products/9.1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/9.2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/9.3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/9.4.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home /  Exerciser</p>
                <h2>Strauss Adjustable Hand Grip Strengthener Hand Exerciser Forearm & Hand Gripper Hand Grip/Fitness Grip  (Blue)</h2>
                <h5>&#8377; 249.00</h5>
