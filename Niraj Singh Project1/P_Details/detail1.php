...
<!--------------------------------------------SINGLE PRODUCT DETAILS--------------------------------------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Products/P1.1.jpg" width="70%" id="ProductImg">
                <div class="small-img-row" >
                    <div class="small-img-col">
                        <img src="Products/P1.1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P1.2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P1.3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Products/P1.4.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home / T-Shirt</p>
                <h1>Sun UV Protection Arm Sleeves for Men/Women</h1>
                <h5>&#8377; 100.00</h5>
                <select class="Size" >
